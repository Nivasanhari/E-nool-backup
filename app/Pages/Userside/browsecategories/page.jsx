...
export default function page() {
  ...
  return (
    <DefaultLayout>
      <section className=" w-full z-40 container mx-auto">
        <div className=" pt-12 leading-6">
          <div className="mx-auto flex justify-between items-center sm:px-16 px-6 mt-20 lg:max-w-screen-2xl w-11/12  text-[#015464]">
            <nav>
          ...
          <div className="  md-px-24 relative  container  mx-auto">
            ...
            <div className="lg:flex justify-between mb-10 ">
              ...
              >
                ...
                <Image src={dropdown} alt="Dropdown" className="w-3 h-3" width={3}
                  height={3} />
              </button>
            ...
            <div className="sm:flex pt-3 sm:space-x-3 mx-auto justify-end ">
              ...
              <div ref={dropdownRef}>
                {isSortOpen && (
                  <ul className="absolute mt-2 z-50  right-10 top-44 py-2 w-52 bg-[#EEF2F6] border border-gray-200 shadow-lg rounded-md ">
                    <Link href="#">
                      <li className="pl-5 text-[#015464] text-sm my-3 ">
                        Lorem ipsum{" "}
                      </li>
