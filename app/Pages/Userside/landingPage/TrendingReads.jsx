        ...
        <div className="  md-px-24 relative  container mx-auto">
          <div className="flex flex-wrap w-full mb-10">
            <div className="lg:w-1/2 w-full mb-6 lg:mb-0 ">
              <h1 className=" text-3xl font-graphikBold title-font mb-2 text-[#015464]">Trending Reads</h1>
            ...
            <div className="lg:w-1/2 w-full mb-6 lg:mb-0 flex lg:justify-end ">
              <Link href='/Pages/Userside/trendingPage'>
                <button className=" text-white bg-[#015464] border-0 py-2 px-6 focus:outline-none w-28 h-10 rounded-[21px] text-sm "><h1 className="items-center font-graphik">View all</h1></button></Link>
            </div>
          </div>
...
<div className=" relative z-0">
          ...
          <div className="swiper-navigation-buttons">
            <Image src={leftarrow} className="swiper-button-prev-1 absolute lg:top-64 top-96 z-50 cursor-pointer" />
            <Image src={rightarrow} className="swiper-button-next-1 absolute right-0 lg:top-64 top-96 z-50 cursor-pointer" />
          </div>
