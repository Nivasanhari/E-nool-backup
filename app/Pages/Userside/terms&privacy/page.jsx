...
const privacy = () => {
    return (<DefaultLayout>
        <div className="min-[2000px]:container min-[2000px]:mx-auto">
            ...
            <div className=' mb-10 min-[2000px]:container min-[2000px]:mx-auto '>
                ...
                <div className='  justify-center items-center flex top-40 z-0 absolute '>
                    <div className=' max-w-3xl ml-48'>
                        <Image src={privacypolicy} alt='privacypolicy-img' />
                        <h1 className=' text-[#015464] font-graphikBold text-5xl'>Privacy Policy</h1>
                    </div>
            ...
            <div className=' mt-40 mb-24 justify-center items-center flex flex-col m-auto '>
                <div className=' bg-white'>
                    <h1 className=' text-[#015464] font-semibold text-2xl pb-5 font-graphik'>As of April 07th,2023</h1>
