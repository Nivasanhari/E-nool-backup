      ...
      <div className=" m-auto font-graphik">
        ...
        <div className="publisher_bg ">
          <div className=" pt-12 leading-6">
            <div className="mx-auto px-4 sm:px-6 lg:px-8 mt-20 ml-40 text-[#015464]">
              <nav>
        ...
        <div className="mx-auto flex justify-between items-center sm:px-16 px-6 my-10 ">
          <div className="flex flex-col items-center w-full ">
            ...
            <div className="w-2/6 ">
              ...
              />
              <button className=" bg-[#7CC9B5] opacity-1 items-start mt-8 ml-4 p-2 px-5  rounded-2xl text-white text-sm h-10 w-36 ">
                Subscribe{" "}
              </button>
            </div>
          </div>
