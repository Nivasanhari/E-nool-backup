...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 54858)), "C:\\Users\\nivas\\Downloads\\E-nool-backup\\app\\Pages\\Userside\\flipbook\\page.jsx"],
    ...
    const originalPathname = "/Pages/Userside/flipbook/page"
    const __next_app__ = {
    ...
    const options = {"definition":{"kind":"APP_PAGE","page":"/Pages/Userside/flipbook/page","pathname":"/Pages/Userside/flipbook","bundlePath":"app/Pages/Userside/flipbook/page","filename":"","appPaths":[]}}
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 82120))
...
var build = __webpack_require__(98320);
;// CONCATENATED MODULE: ./public/assets/Flipbook/pdf.png
...
const Flipbook = ()=>{
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        className: "my-10 mx-auto  max-w-xl  rounded-xl border readbook py-10 px-4 text-center sm:px-10 lg:max-w-screen-xl max-h-screen-xl lg:flex-row lg:text-left",
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx((image_default()), {
                className: " absolute z-0 bottom-20 left-0 w-16 ",
                src: Leaf1["default"],
                alt: ""
            }),
            /*#__PURE__*/ jsx_runtime_.jsx((image_default()), {
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                className: "flex flex-row my-36",
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                        className: "mx-20  ",
                        children: /*#__PURE__*/ jsx_runtime_.jsx("div", {
                            className: "bg-[#015464] p-6 rounded-2xl shadow-md m-auto mt-12",
                            children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                className: "flex flex-col items-center py-10",
                                children: [
                                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                        className: "-mt-20 flex h-20 w-20 items-center justify-center rounded-full bg-blue-500 text-white",
                                        children: /*#__PURE__*/ jsx_runtime_.jsx((image_default()), {
                                            src: pdf
                                        })
                                    }),
                                    /*#__PURE__*/ jsx_runtime_.jsx("span", {
                                        className: "my-10  text-center font-medium capitalize font-graphikBold text-white text-4xl",
                                        children: "This is the end of the sample."
                                    }),
                                    /*#__PURE__*/ jsx_runtime_.jsx("button", {
                                        type: "button",
                                        className: "w-full h-10 sm:w-50 items-center rounded-full bg-[white]  text-[#015464] font-graphik  p-2 text-center  text-xs ",
                                        children: "For Download Buy Now!"
                                    })
                                ]
                            })
                        })
                            ...
                            children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ jsx_runtime_.jsx("button", {
                                        type: "button",
                                        className: "w-full h-10 sm:w-50 items-center rounded-full bg-[white]  text-[#015464] font-graphik  p-2 text-center  text-xs ",
                                        children: "Continue Reading Subscribe Now!"
                                    })
                                ]
                            })
                        })
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("label", {
                for: "default-range",
                className: "block mb-2 text-xs text-right font-medium  text-white",
                children: "100"
            })
        ]
    });
};
/* harmony default export */ const flipbook_page = (Flipbook);
...
var __webpack_exports__ = __webpack_require__.X(0, [2697,577,2451,1315,8167,6042,4529], () => (__webpack_exec__(62130)));
