...
__webpack_require__.d(__webpack_exports__, {
  ...
  Rv: () => (/* reexport */ freeMode),
  W_: () => (/* reexport */ Navigation),
  tl: () => (/* reexport */ Pagination),
  LW: () => (/* reexport */ Scrollbar)
});

// UNUSED EXPORTS: Controller, EffectCards, EffectCoverflow, EffectCreative, EffectCube, EffectFade, EffectFlip, Grid, HashNavigation, History, Keyboard, Manipulation, Mousewheel, Parallax, Thumbs, Virtual, Zoom
  ...
  function onTouchEnd(_ref2) {
    ...
    if (params.freeMode.momentum) {
      if (data.velocities.length > 1) {
        ...
        if (time > 150 || (0,utils.d)() - lastMoveEvent.time > 300) {
          swiper.velocity = 0;
        }
      } else {
        swiper.velocity = 0;
